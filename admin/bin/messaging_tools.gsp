...
uses java.net.URL
uses gw.webservice.ab.ab1000.messagingtoolsapi.MessagingToolsAPI
...
config.ServerOverrideUrl = new URL(MessagingToolsArgs.Server + "/ws/gw/webservice/ab/ab1000/MessagingToolsAPI").toURI() as String
